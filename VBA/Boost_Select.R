...
# Author: Akanksha Mukhriya

# Unsupervised Boosting based Selection Strategy by Campos et. al. [G. O. Campos, A. Zimek, W. Meira, An unsupervised boosting strategy
# for outlier detection ensembles, in: Proc. PAKDD Conf., 2018, pp. 564-576.]
...
# Combination Technique - Since, in this workwe use Average for combination of 
# Selected_Boost detectors, we do not use it here as an explicit input


# Output:
# Selected_Boost - a vector with 1 for selected detectors and 0 for not selected detectors
